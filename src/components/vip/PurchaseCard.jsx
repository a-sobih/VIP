...
export default function PurchaseStickyCard({ activeVip }) {
  ...
  const currentUserVipId = userProfile?.vip_type?.id;
  ...
  return (
    <>
      ...
      <Dialog open={open} onOpenChange={setOpen} modal={false}>
        <DialogContent
          className="w-full max-w-[95%] md:max-w-4xl backdrop-blur-xl shadow-2xl
        ...
        >
          ...
          <div className="py-4 text-white">
            ...
            {actionType === "send" && (
              <div className="mt-4">
                <FriendCombobox setReceiverId={setReceiverId} />
              </div>
            )}
              ...
              <p className="text-lg font-semibold">
                ...
                {selectedDuration === "day"
                  ...
                  : selectedDuration === "week"
                    ? activeVip?.price_in_week
                    : selectedDuration === "15_days"
                      ? activeVip?.price_in_15_days
